    ...
    public class ControlMessageClass
    {
        ...
        public static async Task TextAsyncFunction(ITelegramBotClient botClient, Update update, CancellationToken cancellationToken)
        {
            ...
            if (message == "/start" || message == "start")
            {
                ...
                text: "\t\t‼️Postni shu tartibda yasaladi\n\n" +
                "\t1️⃣Chanel Name Update => Kanal nomi\n" +
                "\t2️⃣Post Update => Matn qismi\n" +
                "\t3️⃣Image Update => Rasm joylaysiz\n\n" +
                "‼️Malumotlarni to'liq kiritishingiz kerak\n\n" +
